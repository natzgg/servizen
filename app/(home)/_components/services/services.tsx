    ...
    <div className="flex flex-col items-center justify-center w-full mt-20 gap-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 w-full justify-items-center">
        <ServicesCard
          ...
          description="Work remotely and enjoy peace of mind knowing that your information is protected with high level encryption."
        />
        <ServicesCard
          ...
          title="Learn & Grow"
          description="Our proven training and marketing program will help you close more clients and allow you to focus on growing."
        />
        <ServicesCard
          ...
          title="Taxes To Go!"
          description="Reach more clients and prepare tax returns in less time. Chat with your clients in real time from within the app."
        />
        <ServicesCard
          ...
          title="Mentorship"
          description="Schedule individual advanced Marketing and Hiring Strategies (eg: email, social media, job-websites)."
        />
      </div>
    </div>
  );
